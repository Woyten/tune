...
pub fn all_waveforms() -> Vec<Patch> {
    vec![
        ...
        Patch {
            ...
            waveform_type: PatchProperties::Complex {
                phase_fn: |oscis, d_phase, _duration_secs| {
                    oscis.o0.advance_phase(d_phase * 2.1);
        ...
        Patch {
            ...
            waveform_type: PatchProperties::Complex {
                phase_fn: |oscis, d_phase, _duration_secs| {
                    oscis.o0.advance_phase(d_phase * 2.2);
                    oscis.o1.advance_phase(d_phase + oscis.o0.sine3() / 100.0);
                },
                signal_fn: |oscis| oscis.o1.sine3(),
            },
        ...
        Patch {
            name: "Chiptune as diff",
            envelope_type: EnvelopeType::Organ,
            waveform_type: PatchProperties::Complex {
                phase_fn: |oscis, d_phase, _duration_secs| {
                    let old_phase = oscis.o0.sine3() / 100.0;
                    oscis.o0.advance_phase(d_phase * 2.0);
                    let new_phase = old_phase + oscis.o0.sine3() / 100.0;
                    oscis.o1.advance_phase(d_phase + new_phase - old_phase);
                },
                signal_fn: |oscis| oscis.o1.sine3(),
            },
        },
        Patch {
            // This sound implicitly depends on the frequency (d_phase + ...)
            name: "Chiptune as diff integral form",
            envelope_type: EnvelopeType::Organ,
            waveform_type: PatchProperties::Complex {
                phase_fn: |oscis, d_phase, _duration_secs| {
                    let total_d_phase = 2.0 * d_phase;
                    let old_phase = (oscis.o0.cosine().powi(3) / 3.0 - oscis.o0.cosine())
                        / 100.0
                        / TAU
                        / total_d_phase;
                    oscis.o0.advance_phase(d_phase * 2.0);
                    let new_phase = (oscis.o0.cosine().powi(3) / 3.0 - oscis.o0.cosine())
                        / 100.0
                        / TAU
                        / total_d_phase;
                    oscis.o1.advance_phase(d_phase + new_phase - old_phase);
        ...
        Patch {
            ...
            waveform_type: PatchProperties::Complex {
                phase_fn: |oscis, d_phase, _duration_secs| {
                    let old_phase = oscis.o0.sine();
                    oscis.o0.advance_phase(d_phase * 2.0);
                    let new_phase = oscis.o0.sine();
                    oscis
                        .o1
                        .advance_phase(d_phase + (new_phase - old_phase) * 0.0);
                },
                signal_fn: |oscis| oscis.o1.sine(),
            },
        },
        Patch {
            ...
            waveform_type: PatchProperties::Complex {
                phase_fn: |oscis, d_phase, _duration_secs| {
                    ...
                    oscis
                        .o1
                        .advance_phase(d_phase + (new_phase - old_phase) * 0.1);
                },
                signal_fn: |oscis| oscis.o1.sine(),
            },
        },
        Patch {
            ...
            waveform_type: PatchProperties::Complex {
                phase_fn: |oscis, d_phase, _duration_secs| {
                    let old_phase = oscis.o0.sine();
                    oscis.o0.advance_phase(d_phase * 2.01);
                    let new_phase = oscis.o0.sine();
                    oscis
                        .o1
                        .advance_phase(d_phase + (new_phase - old_phase) * 0.2);
                },
                signal_fn: |oscis| oscis.o1.sine(),
            },
        },
        ...
        Patch {
            ...
            waveform_type: PatchProperties::Complex {
                phase_fn: |oscis, d_phase, _duration_secs| {
                    oscis.o0.advance_phase(d_phase);
                    oscis.o1.advance_phase(d_phase + oscis.o0.sine3() / 10.0);
                },
                signal_fn: |oscis| oscis.o1.sine() / 2.0,
            },
        },
